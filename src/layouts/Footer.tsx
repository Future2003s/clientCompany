...
function Footer() {
  return (
    <footer
      className={`w-full mx-auto bg-[#f9f9f9] pt-14 pb-32 bg-[url("/images/footer.png")] bg-left-bottom bg-repeat-x`}
    >
      <div className="container mx-auto grid lg:grid-cols-4 gap-8 justify-between">
