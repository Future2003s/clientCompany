...
const InteractiveHeroSlider: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-20 container mx-auto px-6 h-full flex flex-col justify-center items-center text-center md:items-start md:text-left pointer-events-none">
        <div className="max-w-2xl">
          <div className="overflow-hidden">
            <h1
              key={heroSlides[currentIndex].id}
              className="font-serif text-4xl md:text-6xl lg:text-8xl font-bold animate-slide-up-text"
            >
          ...
          <div className="overflow-hidden">
            <p
              ...
              className="mt-6 text-lg md:text-xl max-w-xl animate-slide-up-text"
          ...
          <div className="overflow-hidden">
            <a
              ...
              className="mt-8 inline-block bg-white text-slate-800 font-bold px-10 py-4 rounded-full shadow-lg hover:bg-rose-100 transition-all duration-300 transform hover:scale-105 animate-slide-up-text pointer-events-auto"
